...
| **truenas** | `__LAN-IP__` | TrueNAS SCALE 25.10.4 — movies library on 2×8TB ZFS mirror, NFS | Bare metal. Serves Jellyfin (read-only static PV) and qbittorrent downloads (docker-1 fstab mount). Weekly config export → Synology → Wasabi. |
